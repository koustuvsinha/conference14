    ...
    <div class="container main_body">
        <div class="row">
            <div class="col-md-9">
                ...
                <p><strong>IEMSCI Paper Categories</strong></p>
                <ul>
                ...
                <p>IEMSCI 2014 welcomes submissions on, but not limited to:</p>
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-default">
                        <div class="panel-heading">
                          <h3 class="panel-title">Topics 1</h3>
                        </div>
                        <div class="panel-body">
                            <ul>
                                <li>Material Science</li>
                                <li>Nano Science & Technology</li>
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                        <div class="panel-heading">
                          <h3 class="panel-title">Topics 2</h3>
                        </div>
                        <div class="panel-body">
                            <ul>
                                <li>Electronic & Photonics Devices</li>
                                <li>Biomics & Biotechnology</li>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-default">
                        <div class="panel-heading">
                          <h3 class="panel-title">Topics 3</h3>
                        </div>
                        <div class="panel-body">
                            <ul>
                                <li>Optimization Techniques</li>
                                <li>Fluid & Applied Mechanics </li>
                                <li>Cosmology & Astrophysics</li>
                ...
                <div class="row">
                    <div class="col-md-12" id="key_dates">
                        ...
                        <table class="table table-hover table-bordered table-responsive">
                            ...
                            <tr class="success"><td>Conference Date</td><td>August 29-30, 2014</td></tr>
                        </table>
                        <br>
