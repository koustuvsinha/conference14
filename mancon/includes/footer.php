...
<script type="text/javascript">
$("ul.dropdown1").hover(function() { $("li.dropdown1").css("background", "rgb(238, 238, 238)")},function(){
    $("li.dropdown1").css("background-color",""); });
$("ul.dropdown2").hover(function() { $("li.dropdown2").css("background", "rgb(238, 238, 238)")},function(){
    $("li.dropdown2").css("background-color",""); });
$("ul.dropdown3").hover(function() { $("li.dropdown3").css("background", "rgb(238, 238, 238)")},function(){
