            ...
            <div class="col-md-9">
                ...
                <ul>
                   <li>Best Paper Awards and Best Student Paper Awards will be conferred at the conference (in order to qualify for the award, the paper must be presented at the conference). </li>
                    <li>Conference Proceedings will be published by <strong>Elsevier</strong> and Indexed by <strong>Elsevier</strong>.</li>
                    <li>Extended version of the paper will be published in the following reputed foreign journals:
                        <ul>
                            <li>American Journal of Business  Management & Public Administration</li>
